	...
	public void run() {
		if(hostname == null || port == -1){
			...
			try {
				...
				commandInvoker.register("remove_head", new RemoveHead(commandReceiver));
				...
				commandInvoker.register("average_of_album_count", new AverageOfAlbumCount(commandReceiver));
